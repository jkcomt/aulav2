...
class MaestroController extends Controller
{
    ...
    public function index(Request $request)
    {
      if ($request) {
        ...
        ->orderBy('id','desc')
        ->paginate('7');
        return view('miembros.maestros.index',['users'=>$users,'searchtext'=>$query]);
      }
    }
    ...
    public function create()
    {
      ...
      return view('miembros.maestros.create',['grados'=>$grados]);
    }
    ...
    public function store(UserFormRequest $request)
    {
      ...
      return redirect('miembros/maestros');
    }
    ...
    {
      $user = DB::table('users')
              ->join('maestros','users.id','=','maestros.users_id')
              ->join('grados','maestros.grados_id','=','grados.id')
      ...
      // dd($user->toArray());
      // dd($user);
      return view('miembros.maestros.show',['user'=>$user]);
    ...
    public function edit($id)
    {
      ...
      return view('miembros.maestros.edit',['user'=>$user,'grados'=>$grados]);
    }
