...
@section('content')
  <div class="row">
    <div class="col-lg-6 col-md-6 col-ms-6 col-xs-12">
      ...
      @endif
      {!!Form::model($publicacion,['method'=>'PATCH','route'=>['publicaciones.update','id'=>$publicacion->id],'files'=>'true'])!!}
      <div class="form-group">
        {!!Form::label('idcurso','Curso')!!}
        {!!Form::select('idcurso',$cursos,$publicacion->cursos_id,['class'=>'form-control','placeholder'=>'Selecciona Curso']) !!}
      </div>
      <div class="form-group">
