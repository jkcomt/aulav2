...
@section('content')
  <div class="row">
    <div class="col-lg-6 col-md-6 col-ms-6 col-xs-12">
      <h3>Editar Maestro: {{$user->nombres}} {{$user->apellidos}}</h3>
      @if (count($errors) > 0)
      ...
      {!!Form::model($user,['method'=>'PATCH','route'=>['maestros.update','id'=>$user->id],'files'=>'true'])!!}
      <div class="row">
        ...
        <div class="col-lg-6 col-sm-6 col-md-6 col-xs-12" >
          <div class="form-group">
            ...
            {!!Form::select('idgrado',$grados,$user->maestro->grados_id,['class'=>'form-control','placeholder'=>'Selecciona Grado']) !!}
          </div>
        </div>
